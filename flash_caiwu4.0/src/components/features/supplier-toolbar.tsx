...
import { SupplierFormDialog } from "@/components/features/supplier-form-dialog";

/**
 * 供应商工具栏：新增供应商 + 批量导入 + 批量导出 + 打印
 */
export function SupplierToolbar() {
  ...
  function handlePrint() {
    ...
    window.open(`/suppliers/print?${params.toString()}`, "_blank");
  }
