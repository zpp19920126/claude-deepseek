      ...
      <div className="print-container">
        ...
        <div className="print-meta">
          ...
          <div style={{ textAlign: "right" }}>
            <p>购货单位：<strong>{order.customer.shortName || order.customer.name}</strong></p>
            {order.customer.phone && <p>电话：{order.customer.phone}</p>}
            {order.customer.address && <p>地址：{order.customer.address}</p>}
          </div>
        </div>
